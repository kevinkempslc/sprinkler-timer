...
${OBJECTDIR}/SendMail.o: SendMail.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SendMail.o SendMail.cpp

${OBJECTDIR}/SprinklerTimer.o: SprinklerTimer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SprinklerTimer.o SprinklerTimer.cpp
...
${OBJECTDIR}/Zone.o: Zone.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Zone.o Zone.cpp
